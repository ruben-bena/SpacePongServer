...
# Auto-detect fat jar generated by Maven
JAR_PATH=$(find ./target -maxdepth 1 -type f -name "*jar-with-dependencies.jar" | head -n 1)

if [[ -z "$JAR_PATH" ]]; then
    echo "❌ Error: No s'ha trobat cap fat JAR a ./target/"
    exit 1
fi

JAR_NAME=$(basename "$JAR_PATH")

echo "JAR detectat: $JAR_NAME"
